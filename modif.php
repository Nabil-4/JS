...
if ($_POST) {
    ...
    $sql = "UPDATE transaction SET name = '$name', amount = '$amount', date_transaction = '$date' WHERE id_transaction = '$id'";
                ...
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="name"
                            placeholder="Facture d'électricité" value="<?= $data[0]['name'] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="date" class="form-label">Date *</label>
                        <input type="date" class="form-control" name="date" id="date" value="<?= $data[0]['date_transaction'] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="amount" class="form-label">Montant *</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="amount" id="amount" value="<?= $data[0]['amount'] ?>" required>
